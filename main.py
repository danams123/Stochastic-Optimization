...
if __name__ == '__main__':
    ...
    def update_receipts_dict(receipt_dict: dict) -> dict:
        receipt_dict["customer"] = customer_to_id.get(receipt_dict.get("customer_id"))
        return receipt_dict

    with open('reciepts.csv', newline='') as receipts_file:
        receipts_dicts = csv.DictReader(receipts_file,fieldnames=['id', 'waiting_time', 'customer', 'supermarket'])
